...
```{r tab-os-eval, tab.cap = "Performance of machine learning models at prediction of overall survival in the training and test subsets of the GSE16560 cohort. The models used log2 expression of the collagen-related genes as explanatory factors."}
